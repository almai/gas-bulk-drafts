/**
 * Facade to interact with Google Apps Script DocumentApp service
 */
 ...
 */
export function getDocumentContentById(documentId: string): string {
 ...
 */
export function getDocumentNameById(documentId: string): string {
